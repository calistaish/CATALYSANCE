...
function updateProducts(products) {
    ...
    for (var i = 0; i < products.length; i++) {
        ...
        productHTML += '<a href="productdeets.php" class="text-white text-lg w-9 h-9 rounded-full bg-primary hover:bg-gray-800 transition flex items-center justify-center"> <i class="fas fa-search"></i></a>';
        ...
        productHTML += '<a href="productdeets.php"><h4 class="uppercase font-medium text-xl mb-2 text-gray-800 hover:text-primary transition">' + product.name + '</h4></a>';
        productHTML += '<div class="flex items-baseline mb-1 space-x-2">';
        productHTML += '<p class="text-xl text-primary font-roboto font-semibold">₱' + product.originalPrice + '</p>';
