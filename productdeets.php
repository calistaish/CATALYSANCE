...
<!-- breadcrum end -->
   ...
   <div class="container pt-4 pb-6 grid lg:grid-cols-2 gap-6">
    ...
    <div>
        <div>
            <img id="main-img" src="./img/bp12.png" class="w-full zoom">
        </div>
        <div class="grid grid-cols-5 gap-4 mt-4">
            <div>
                <img src="./img/bp13.png" class="single-img w-full cursor-pointer border border-primary">
            </div>
            <div>
    ...
    <!-- product content -->
    <div>
        <h2 class="md:text-3xl text-2xl font-medium uppercase mb-2">NewJeans KPOp Tote Bag</h2>
        ...
        <div class="space-y-2">
            ...
            <p class="space-x-2">
                ...
                <span class="text-gray-600">KPop</span>
            </p>
            <p class="space-x-2">
                <span class="text-gray-800 font-semibold">Category: </span>
                <span class="text-gray-600">Tote Bag</span>
            </p>
            <p class="space-x-2">
        ...
        <div class="mt-4 flex items-baseline gap-3">
            <span class="text-primary font-semibold text-xl1">₱150.00</span>
        </div>
