...
LOAD DATA INFILE 'C:/Users/63948/Downloads/Mugs.csv'
INTO TABLE products
...
create view order_summary as
select C.cart_id, I.item_id, P.name, T.theme, I.quantity, P.price, P.price * I.quantity as subtotal
from Cart C, cart_items I, products P, themes T where C.cart_id = I.cart_id and P.id = I.product_id and P.theme_id = T.id;
