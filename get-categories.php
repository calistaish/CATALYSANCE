<?php
    $sql = "SELECT categories.id as id, categories.category as name, count(products.category_id) as count FROM categories join products on categories.id = products.category_id group by id";
